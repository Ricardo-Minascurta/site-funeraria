...
const includedServices = [
  ...
  'Urna adequada para cremação',
  'Tratamento de toda a documentação legal',
  'Coordenação com o crematório',
  'Cerimónia antes da cremação',
  'Entrega das cinzas em urna cinerária',
  'Acompanhamento dedicado à família',
]

const destinosCinzas = [
  {
    title: 'Urna Cinerária',
    description: 'Guarda das cinzas em urna decorativa para conservar em casa ou colocar em columbário.',
    icon: (
  ...
  {
    title: 'Sepultura ou Jazigo',
    description: 'Inumação das cinzas em sepultura ou jazigo familiar, junto de outros entes queridos.',
    icon: (
      <svg className="w-6 h-6 text-gold-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    title: 'Dispersão em Terra',
    description: 'Dispersão das cinzas em local significativo: jardim, montanha ou outro espaço especial.',
    icon: (
      <svg className="w-6 h-6 text-gold-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    title: 'Dispersão no Mar',
    description: 'Cerimónia de dispersão das cinzas no oceano, uma despedida serena e simbólica.',
    icon: (
      <svg className="w-6 h-6 text-gold-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
const otherServices = [
  {
    name: 'Funeral Sepultura',
    description: 'Inumação em sepultura temporária ou perpétua',
...
export default function FuneralCremacao() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative min-h-[55vh] lg:min-h-[65vh] flex items-end overflow-hidden">
        ...
        <div className="absolute inset-0">
          <Image
            ...
            alt="Funeral Cremação - Memória Eternus"
            fill
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 lg:pb-24 pt-40">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-serif font-semibold text-white leading-[1.1] mb-6">
            Funeral <span className="text-gold-400">Cremação</span>
          </h1>
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <div>
                ...
                <h2 className="text-3xl sm:text-4xl font-serif font-semibold text-brown-dark leading-tight mb-6">
                  Cremação com <span className="text-gold-600">Dignidade</span>
                </h2>
                ...
                <div className="prose prose-lg max-w-none">
                  <p className="text-brown-dark/80 leading-relaxed mb-6">
                    A cremação é uma alternativa cada vez mais escolhida, oferecendo flexibilidade
                    no destino final das cinzas e permitindo cerimónias personalizadas. Na Memória
                    Eternus, acompanhamos todo o processo com o respeito e a dignidade que este
                    momento merece.
                  </p>
                  <p className="text-brown-dark/80 leading-relaxed">
                    Coordenamos todos os detalhes com o crematório, organizamos a cerimónia de
                    despedida e garantimos que as cinzas são entregues à família numa urna
              ...
              <div>
                <h3 className="text-2xl font-serif font-semibold text-brown-dark mb-6">
                  Destino das Cinzas
                </h3>
                <p className="text-brown-dark/70 mb-8">
                  Após a cremação, existem várias opções para o destino final das cinzas,
                  cada uma com o seu significado especial.
                </p>

                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {destinosCinzas.map((destino, index) => (
                    <div
                      key={index}
                      className="group bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-300 border border-gold-400/10"
                    >
                      <div className="w-10 h-10 rounded-full bg-gold-400/10 flex items-center justify-center mb-4">
                        {destino.icon}
                      </div>
                      <h4 className="text-lg font-serif font-semibold text-brown-dark mb-2">
                        {destino.title}
                      </h4>
