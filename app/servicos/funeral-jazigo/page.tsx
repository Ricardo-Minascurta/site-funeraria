...
const includedServices = [
  ...
  'Urna funerária de qualidade superior',
  'Tratamento de toda a documentação legal',
  'Coordenação com o cemitério',
  'Abertura e fecho do jazigo',
  'Coroa de flores natural',
  'Acompanhamento personalizado à família',
]
...
export default function FuneralJazigo() {
  return (
    <>
      {/* Hero Section */}
      <section className="relative min-h-[55vh] lg:min-h-[65vh] flex items-end overflow-hidden">
        ...
        <div className="absolute inset-0">
          <Image
            ...
            alt="Funeral Jazigo - Memória Eternus"
            fill
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 lg:pb-24 pt-40">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-serif font-semibold text-white leading-[1.1] mb-6">
            Funeral <span className="text-gold-400">Jazigo</span>
          </h1>
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <div>
                ...
                <h2 className="text-3xl sm:text-4xl font-serif font-semibold text-brown-dark leading-tight mb-6">
                  Inumação em <span className="text-gold-600">Jazigo</span>
                </h2>
                ...
                <div className="prose prose-lg max-w-none">
                  <p className="text-brown-dark/80 leading-relaxed mb-6">
                    O serviço de funeral com jazigo oferece uma solução digna e permanente
                    para o repouso do seu ente querido. Esta opção permite manter a família
                    reunida num espaço próprio, facilitando as visitas e homenagens ao longo
                    dos anos.
                  </p>
                  <p className="text-brown-dark/80 leading-relaxed">
                    Na Memória Eternus, coordenamos todos os aspetos da cerimónia e inumação,
                    desde a preparação do corpo até à organização do serviço religioso ou civil,
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="group bg-white rounded-xl p-8 shadow-md hover:shadow-lg transition-shadow duration-300 border border-gold-400/10">
                  ...
                  <p className="text-brown-dark/70 text-sm leading-relaxed">
                    Espaço próprio da família, com capacidade para múltiplas inumações.
                    Uma solução permanente que permite manter todos os entes queridos
                ...
                <div className="group bg-white rounded-xl p-8 shadow-md hover:shadow-lg transition-shadow duration-300 border border-gold-400/10">
                  ...
                  <p className="text-brown-dark/70 text-sm leading-relaxed">
                    Espaço em jazigo municipal, ideal para quem não possui jazigo próprio.
                    Oferece as mesmas condições de dignidade e respeito, com gestão
                    municipal do espaço.
                  </p>
                </div>
              </div>
